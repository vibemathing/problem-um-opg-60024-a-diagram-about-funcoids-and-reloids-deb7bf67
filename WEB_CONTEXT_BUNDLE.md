...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-60024"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-v1",
      "problem_contract_sha256": "832f685b9035c5a2a2424c3594b59e2e842f7625011a933db17b1a03788794d9",
      "problem_id": "problem:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67",
      "route_id": "route:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-source-fidelity-01",
      "graph_id": "graph:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Define for posets with order $\\sqsubseteq$: - $\\Phi_{\\ast} f = \\lambda b \\in \\mathfrak{B}: \\bigcup \\{ x \\in \\mathfrak{A} \\mid f x \\sqsubseteq b \\}$; - $\\Phi^{\\ast} f = \\lambda b \\in \\mathfrak{A}: \\bigcap \\{ x \\in \\mathfrak{B} \\mid f x \\sqsupseteq b \\}$. Note that the above is a generalization of monotone Galois connections (with $\\max$ and $\\min$ replaced with suprema and infima). Then we have the following diagram: What is at the node \"other\" in the diagram is unknown. Conjecture \"Other\" is $\\lambda f\\in\\mathsf{FCD}: \\top$. Question What repeated applying of $\\Phi_{\\ast}$ and $\\Phi^{\\ast}$ to \"other\" leads to? Particularly, does repeated applying $\\Phi_{\\ast}$ and/or $\\Phi^{\\ast}$ to the node \"other\" lead to finite or infinite sets?"
          },
          "statement_sha256": "d24dc3ee01c255673a078ed7c4e1a220990b49b61e938b7b0144bffba3ce0f94"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-root",
      "route_id": "route:um-opg-60024-a-diagram-about-funcoids-and-reloids-deb7bf67-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-60024-a922822ac6de",
        "url": "https://www.unsolvedmath.com/problems/OPG-60024"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
